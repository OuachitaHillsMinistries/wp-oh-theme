...
class wp_bootstrap_navwalker extends Walker_Page {
	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $currentPageId = 0 ) {
		...
		if ( $args['walker']->has_children && $depth === 0 ) {
			...
			$atts['href'] = ! empty( $item->ID ) ? get_permalink($item->ID)	: '';
		}
		...
		$item_output .= ( $args['walker']->has_children && 0 === $depth ) ? ' <span class="caret"></span></a>' : '</a>';
